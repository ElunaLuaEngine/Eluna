...
namespace LuaPlayer
{
    ...
    {
        E->Push(E->L, player->CanTitanGrip());
        return 1;
    }
    ...
    int HasTalent(Eluna* E, Player* player)
    {
        ...
        if (spec >= maxSpecs)
            return 1;
        E->Push(E->L, player->HasTalent(spellId, spec));
        return 1;
    }
    ...
    int HasAchieved(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->HasAchieved(achievementId));
#else
        E->Push(E->L, player->GetAchievementMgr().HasAchievement(achievementId));
#endif
        return 1;
    }
#endif
    ...
    int HasQuest(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->IsActiveQuest(quest));
        return 1;
    }
    ...
    int HasSkill(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->HasSkill(skill));
        return 1;
    }
    ...
    int HasAtLoginFlag(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->HasAtLoginFlag((AtLoginFlags)flag));
        return 1;
    }
    ...
    int HasQuestForGO(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->HasQuestForGO(entry));
        return 1;
    }
    ...
    int HasTitle(Eluna* E, Player* player)
    {
        ...
        if (titleInfo)
            E->Push(E->L, player->HasTitle(titleInfo));
        return 1;
    }
#endif
    ...
    int HasItem(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->HasItemCount(itemId, count, check_bank));
        return 1;
    }
    ...
    int HasQuestForItem(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->HasQuestForItem(entry));
        return 1;
    }
    ...
    int CanUseItem(Eluna* E, Player* player)
    {
        ...
        if (item)
            E->Push(E->L, player->CanUseItem(item) == EQUIP_ERR_OK);
        else
        {
            uint32 entry = Eluna::CHECKVAL<uint32>(E->L, 2);
            const ItemTemplate* temp = eObjectMgr->GetItemTemplate(entry);
            if (temp)
                E->Push(E->L, player->CanUseItem(temp) == EQUIP_ERR_OK);
            else
                E->Push(E->L, false);
        }
        return 1;
...
#ifdef TRINITY
        E->Push(E->L, player->GetSpellHistory()->HasCooldown(spellId));
#else
        E->Push(E->L, player->HasSpellCooldown(spellId));
#endif
        return 1;
    }
    ...
    int CanShareQuest(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->CanShareQuest(entry));
        return 1;
    }
    ...
    {
#ifdef TRINITY
        E->Push(E->L, player->GetSession()->CanSpeak());
#else
        E->Push(E->L, player->CanSpeak());
#endif
        return 1;
    }
    ...
    {
        E->Push(E->L, player->CanUninviteFromGroup() == ERR_PARTY_RESULT_OK);
        return 1;
    }
    ...
    int GetHonorStoredKills(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->GetHonorStoredKills(honorable));
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetRankPoints());
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetHonorLastWeekStandingPos());
        return 1;
    }
#endif
    ...
    {
        E->Push(E->L, (player->GetGroup() != NULL));
        return 1;
    }
    ...
    {
        E->Push(E->L, (player->GetGuildId() != 0));
        return 1;
    }
    ...
    int IsGM(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->IsGameMaster());
#else
        E->Push(E->L, player->isGameMaster());
#endif
        return 1;
    ...
    {
        E->Push(E->L, player->isTotalImmune());
        return 1;
    }
    ...
    int CanCompleteQuest(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->CanCompleteQuest(entry));
        return 1;
    }
    ...
    {
#ifdef AZEROTHCORE
        E->Push(E->L, (player->GetTeamId() == TEAM_HORDE));
#else
        E->Push(E->L, (player->GetTeam() == HORDE));
#endif
        return 1;
    }
    ...
    {
#ifdef AZEROTHCORE
        E->Push(E->L, (player->GetTeamId() == TEAM_ALLIANCE));
#else
        E->Push(E->L, (player->GetTeam() == ALLIANCE));
#endif
        return 1;
    }
    ...
    int IsGroupVisibleFor(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->IsGroupVisibleFor(target));
        return 1;
    }
    ...
    {
        Player* target = Eluna::CHECKOBJ<Player>(E->L, 2);
        E->Push(E->L, player->IsInSameRaidWith(target));
        return 1;
    }
    ...
    {
        Player* target = Eluna::CHECKOBJ<Player>(E->L, 2);
        E->Push(E->L, player->IsInSameGroupWith(target));
        return 1;
    }
    ...
    int IsHonorOrXPTarget(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->isHonorOrXPTarget(victim));
        return 1;
    }
    ...
    int IsVisibleForPlayer(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->IsVisibleGloballyFor(target));
        return 1;
    }

    int IsGMVisible(Eluna* E, Player* player)
    {
        E->Push(E->L, player->isGMVisible());
        return 1;
    }
    ...
    {
#ifdef MANGOS
        E->Push(E->L, player->IsTaxiCheater());
#else
        E->Push(E->L, player->isTaxiCheater());
#endif
        return 1;
    ...
    {
        E->Push(E->L, player->isAcceptWhispers());
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetRestBonus() > 0.0f);
        return 1;
    }
    ...
    {
#if defined TRINITY || AZEROTHCORE
        E->Push(E->L, player->InBattlegroundQueue());
#else
        E->Push(E->L, player->InBattleGroundQueue());
#endif
        return 1;
    ...
    {
#if defined TRINITY || AZEROTHCORE
        E->Push(E->L, player->InBattleground());
#else
        E->Push(E->L, player->InBattleGround());
#endif
        return 1;
    ...
    /*int CanFlyInZone(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->IsKnowHowFlyIn(mapid, zone));
        return 1;
    }*/

    /*int HasPendingBind(Eluna* E, Player* player)
    {
        E->Push(E->L, player->PendingHasPendingBind());
        return 1;
    }*/

    /*int IsARecruiter(Eluna* E, Player* player)
    {
        E->Push(E->L, player->GetSession()->IsARecruiter() || (player->GetSession()->GetRecruiterId() != 0));
        return 1;
    }*/
    ...
    {
        E->Push(E->L, player->GetSpecsCount());
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetActiveSpec());
        return 1;
    }
#endif
    ...
    {
        E->Push(E->L, player->GetPhaseMaskForSpawn());
        return 1;
    }
#endif
    ...
    {
        E->Push(E->L, player->GetArenaPoints());
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetHonorPoints());
        return 1;
    }
#endif
    ...
    {
        E->Push(E->L, player->GetShieldBlockValue());
        return 1;
    }
#endif
    ...
    int GetSpellCooldownDelay(Eluna* E, Player* player)
    {
        ...
        if (SpellInfo const* spellInfo = sSpellMgr->GetSpellInfo(spellId))
            E->Push(E->L, player->GetSpellHistory()->GetRemainingCooldown(spellInfo));
        else
            E->Push(E->L, 0);
#else
        E->Push(E->L, uint32(player->GetSpellCooldownDelay(spellId)));
#endif
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetSession()->GetLatency());
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetChampioningFaction());
        return 1;
    }
#endif
    ...
    {
        E->Push(E->L, player->GetOriginalSubGroup());
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetOriginalGroup());
        return 1;
    }
...
#ifndef CMANGOS
        E->Push(E->L, player->GetNextRandomRaidMember(radius));
#else
        E->Push(E->L, player->GetNextRandomRaidMember(radius, SPELL_AURA_NONE));
#endif
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetGroupInvite());
        return 1;
    }
    ...
    int GetXPRestBonus(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->GetXPRestBonus(xp));
        return 1;
    }
    ...
    {
#if defined TRINITY || AZEROTHCORE
        E->Push(E->L, player->GetBattlegroundTypeId());
#else
        E->Push(E->L, player->GetBattleGroundTypeId());
#endif
        return 1;
    ...
    {
#if defined TRINITY || AZEROTHCORE
        E->Push(E->L, player->GetBattlegroundId());
#else
        E->Push(E->L, player->GetBattleGroundId());
#endif
        return 1;
    ...
    int GetReputationRank(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->GetReputationRank(faction));
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetDrunkValue());
        return 1;
    }
    ...
    int GetSkillTempBonusValue(Eluna* E, Player* player)
    {
        uint32 skill = Eluna::CHECKVAL<uint32>(E->L, 2);
#ifdef CMANGOS
        E->Push(E->L, player->GetSkillBonusTemporary(skill));
#else
        E->Push(E->L, player->GetSkillTempBonusValue(skill));
#endif
        return 1;
    }
    ...
    int GetSkillPermBonusValue(Eluna* E, Player* player)
    {
        uint32 skill = Eluna::CHECKVAL<uint32>(E->L, 2);
#ifdef CMANGOS
        E->Push(E->L, player->GetSkillBonusPermanent(skill));
#else
        E->Push(E->L, player->GetSkillPermBonusValue(skill));
#endif
        return 1;
    }
    ...
    int GetPureSkillValue(Eluna* E, Player* player)
    {
        uint32 skill = Eluna::CHECKVAL<uint32>(E->L, 2);
#ifdef CMANGOS
        E->Push(E->L, player->GetSkillValuePure(skill));
#else
        E->Push(E->L, player->GetPureSkillValue(skill));
#endif
        return 1;
    }
    ...
    int GetBaseSkillValue(Eluna* E, Player* player)
    {
        uint32 skill = Eluna::CHECKVAL<uint32>(E->L, 2);
#ifdef CMANGOS
        E->Push(E->L, player->GetSkillValueBase(skill));
#else
        E->Push(E->L, player->GetBaseSkillValue(skill));
#endif
        return 1;
    }
    ...
    int GetSkillValue(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->GetSkillValue(skill));
        return 1;
    }
    ...
    int GetPureMaxSkillValue(Eluna* E, Player* player)
    {
        uint32 skill = Eluna::CHECKVAL<uint32>(E->L, 2);
#ifdef CMANGOS
        E->Push(E->L, player->GetSkillMaxPure(skill));
#else
        E->Push(E->L, player->GetPureMaxSkillValue(skill));
#endif
        return 1;
    }
    ...
    int GetMaxSkillValue(Eluna* E, Player* player)
    {
        uint32 skill = Eluna::CHECKVAL<uint32>(E->L, 2);
#ifdef CMANGOS
        E->Push(E->L, player->GetSkillMax(skill));
#else
        E->Push(E->L, player->GetMaxSkillValue(skill));
#endif
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetManaBonusFromIntellect());
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetHealthBonusFromStamina());
        return 1;
    }
    ...
    {
#ifdef TBC
        E->Push(E->L, player->GetDifficulty());
#elif defined(CLASSIC)
        E->Push(E->L, (Difficulty)0);
#else
        bool isRaid = Eluna::CHECKVAL<bool>(E->L, 2, true);
        E->Push(E->L, player->GetDifficulty(isRaid));
#endif
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetFreeTalentPoints());
        return 1;
    }
    ...
    int GetGuildName(Eluna* E, Player* player)
    {
        if (!player->GetGuildId())
            return 1;
        E->Push(E->L, eGuildMgr->GetGuildNameById(player->GetGuildId()));
        return 1;
    }
    ...
    int GetReputation(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->GetReputationMgr().GetReputation(faction));
        return 1;
    }
    ...
    {
#if defined TRINITY || AZEROTHCORE
        E->Push(E->L, player->GetComboTarget());
#else
        E->Push(E->L, player->GetMap()->GetUnit(player->GetComboTargetGuid()));
#endif
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetComboPoints());
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetInGameTime());
        return 1;
    }
    ...
    int GetQuestStatus(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->GetQuestStatus(entry));
        return 1;
    }
    ...
    int GetQuestRewardStatus(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->GetQuestRewardStatus(questId));
        return 1;
    }
    ...
    int GetReqKillOrCastCurrentCount(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->GetReqKillOrCastCurrentCount(questId, entry));
        return 1;
    }
...
#if defined TRINITY || AZEROTHCORE
        E->Push(E->L, player->GetQuestLevel(quest));
#else
        E->Push(E->L, player->GetQuestLevelForPlayer(quest));
#endif
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetRestBonus());
        return 1;
    }
    ...
    int GetItemByPos(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->GetItemByPos(bag, slot));
        return 1;
    }
    ...
    int GetItemByGUID(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->GetItemByGuid(guid));
        return 1;
    }
    ...
    int GetMailItem(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->GetMItem(guid.GetCounter()));
        return 1;
    }
    ...
    int GetItemByEntry(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->GetItemByEntry(entry));
        return 1;
    }
    ...
    int GetGossipTextId(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->GetGossipTextId(obj));
        return 1;
    }
    ...
    {
#if defined TRINITY || AZEROTHCORE
        E->Push(E->L, player->GetSelectedUnit());
#else
        E->Push(E->L, player->GetMap()->GetUnit(player->GetSelectionGuid()));
#endif
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetSession()->GetSecurity());
        return 1;
    }
    ...
    int GetItemCount(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->GetItemCount(entry, checkinBank));
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetUInt32Value(PLAYER_FIELD_LIFETIME_HONORABLE_KILLS));
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetSession()->GetRemoteAddress());
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetLevelPlayedTime());
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetTotalPlayedTime());
        return 1;
    }
    ...
    {
        E->Push(E->L, eGuildMgr->GetGuildById(player->GetGuildId()));
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetSession()->GetAccountId());
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetSession()->GetSessionDbLocaleIndex());
        return 1;
    }
    ...
    {
        E->Push(E->L, player->GetSession()->GetSessionDbcLocale());
        return 1;
    }

    /*int GetRecruiterId(Eluna* E, Player* player)
    {
        E->Push(E->L, player->GetSession()->GetRecruiterId());
        return 1;
    }*/

    /*int GetSelectedPlayer(Eluna* E, Player* player)
    {
        E->Push(E->L, player->GetSelectedPlayer());
        return 1;
    }*/
    ...
    {
        E->Push(E->L, ChatHandler(player->GetSession()).GetNearbyGameObject());
        return 1;
    }*/
    ...
    {
#ifdef CATA
        E->Push(E->L, player->GetNextResetTalentsCost());
#else
#ifdef TRINITY
        E->Push(E->L, player->ResetTalentsCost());
#else
        E->Push(E->L, player->resetTalentsCost());
#endif
#endif
    ...
    int EquipItem(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, player->EquipItem(dest, item, true));
...
#endif
        E->Push(E->L, player->TeleportTo(mapId, x, y, z, o));
        return 1;
    }
    ...
    int AddItem(Eluna* E, Player* player)
    {
        ...
        E->Push(E->L, item);
#else
        E->Push(E->L, player->StoreNewItemInInventorySlot(itemId, itemCount));
#endif
        return 1;
    }
    ...
    E->Push(E->L, player->AddTalent(spellId, spec, learning));
    return 1;
    }*/
