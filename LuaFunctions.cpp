...
ElunaRegister<Unit> UnitMethods[] =
{
    ...
    { "UpdateSpeed", &LuaUnit::UpdateSpeed },
    ...
    #ifdef AZEROTHCORE
        { "IsCommandAttack" , &LuaUnit::IsCommandAttack },
        { "IsCommandFollow" , &LuaUnit::IsCommandFollow },
        { "IsAtStay" , &LuaUnit::IsAtStay },
        { "IsFollowing" , &LuaUnit::IsFollowing },
        { "IsReturning" , &LuaUnit::IsReturning },
        { "IsAttackReady" , &LuaUnit::IsAttackReady },
        { "IsWithinCombatRange" , &LuaUnit::IsWithinCombatRange },
        { "IsWithinMeleeRange" , &LuaUnit::IsWithinMeleeRange },
        { "IsSummon" , &LuaUnit::IsSummon },
        { "IsGuardian" , &LuaUnit::IsGuardian },
        { "IsPet" , &LuaUnit::IsPet },
        { "IsHunterPet" , &LuaUnit::IsHunterPet },
        { "IsTotem" , &LuaUnit::IsTotem },
        { "IsVehicle" , &LuaUnit::IsVehicle },
        { "IsHostileTo" , &LuaUnit::IsHostileTo },
        { "IsHostileToPlayers" , &LuaUnit::IsHostileToPlayers },
        { "IsFriendlyTo" , &LuaUnit::IsFriendlyTo },
        { "IsNeutralToAll" , &LuaUnit::IsNeutralToAll },
        { "IsInPartyWith" , &LuaUnit::IsInPartyWith },
        { "IsInRaidWith" , &LuaUnit::IsInRaidWith },
        { "IsContestedGuard" , &LuaUnit::IsContestedGuard },
        { "IsInSanctuary" , &LuaUnit::IsInSanctuary },
        { "IsFFAPvP" , &LuaUnit::IsFFAPvP },
        { "IsSitState" , &LuaUnit::IsSitState },
        { "IsStandState" , &LuaUnit::IsStandState },
        { "IsCritter" , &LuaUnit::IsCritter },
        { "IsInFlight" , &LuaUnit::IsInFlight },
        { "IsInCombatWith" , &LuaUnit::IsInCombatWith },
        { "IsPetInCombat" , &LuaUnit::IsPetInCombat },
        { "IsFeared" , &LuaUnit::IsFeared },
        { "IsPolymorphed" , &LuaUnit::IsPolymorphed },
        { "IsFrozen" , &LuaUnit::IsFrozen },
        { "IsTargetableForAttack" , &LuaUnit::IsTargetableForAttack },
        { "IsValidAttackTarget" , &LuaUnit::IsValidAttackTarget },
        { "IsValidAssistTarget" , &LuaUnit::IsValidAssistTarget },
        { "IsLevitating" , &LuaUnit::IsLevitating },
        { "IsWalking" , &LuaUnit::IsWalking },
        { "IsControlledByPlayer" , &LuaUnit::IsControlledByPlayer },
        { "IsCreatedByPlayer" , &LuaUnit::IsCreatedByPlayer },
        { "IsCharmedOwnedByPlayerOrPlayer" , &LuaUnit::IsCharmedOwnedByPlayerOrPlayer },
        { "IsPossessed" , &LuaUnit::IsPossessed },
        { "IsPossessedByPlayer" , &LuaUnit::IsPossessedByPlayer },
        { "IsPossessing" , &LuaUnit::IsPossessing },
        { "IsNonMeleeSpellCast" , &LuaUnit::IsNonMeleeSpellCast },
        { "IsInFeralForm" , &LuaUnit::IsInFeralForm },
        { "IsInDisallowedMountForm" , &LuaUnit::IsInDisallowedMountForm },
        { "IsInFrontInMap" , &LuaUnit::IsInFrontInMap },
        { "IsInBackInMap" , &LuaUnit::IsInBackInMap },
        { "IsVisible" , &LuaUnit::IsVisible },
        { "IsUnderLastManaUseEffect" , &LuaUnit::IsUnderLastManaUseEffect },
        { "IsImmunedToSpell" , &LuaUnit::IsImmunedToSpell },
        { "IsImmunedToDamage" , &LuaUnit::IsImmunedToDamage },
        { "IsImmunedToSchool" , &LuaUnit::IsImmunedToSchool },
        { "IsImmunedToDamageOrSchool" , &LuaUnit::IsImmunedToDamageOrSchool },
        { "IsImmunedToSpellEffect" , &LuaUnit::IsImmunedToSpellEffect },
        { "IsDamageReducedByArmor" , &LuaUnit::IsDamageReducedByArmor },
        { "IsPetAura" , &LuaUnit::IsPetAura },
        { "IsAIEnabled" , &LuaUnit::IsAIEnabled },
        { "IsMoving" , &LuaUnit::IsMoving },
        { "IsTurning" , &LuaUnit::IsTurning },
        { "IsHovering" , &LuaUnit::IsHovering },
        { "IsSwimming" , &LuaUnit::IsSwimming },
        { "IsFlying" , &LuaUnit::IsFlying },
        { "IsFalling" , &LuaUnit::IsFalling },
        { "IsBeingLoaded" , &LuaUnit::IsBeingLoaded },
        { "IsDuringRemoveFromWorld" , &LuaUnit::IsDuringRemoveFromWorld },
        { "IsTargetNotAcceptableByMMaps" , &LuaUnit::IsTargetNotAcceptableByMMaps },
        { "IsOutdoors" , &LuaUnit::IsOutdoors },
        // { "IsAlwaysVisibleFor" , &LuaUnit::IsAlwaysVisibleFor },
        // { "IsAlwaysDetectableFor" , &LuaUnit::IsAlwaysDetectableFor },
    #endif
#ifndef CLASSIC
