...
namespace LuaQuery
{
    ...
    int IsNull(Eluna* E, ElunaQuery* result)
    {
        ...
        E->Push(E->L, RESULT->Fetch()[col].IsNull());
#else
        E->Push(E->L, RESULT->Fetch()[col].IsNULL());
#endif
        return 1;
    ...
    {
        E->Push(E->L, RESULT->GetFieldCount());
        return 1;
    }
    ...
    int GetRowCount(Eluna* E, ElunaQuery* result)
    {
        if (RESULT->GetRowCount() > (uint32)-1)
            ...
            E->Push(E->L, (uint32)(RESULT->GetRowCount()));
        return 1;
    }
    ...
    int GetBool(Eluna* E, ElunaQuery* result)
    {
        uint32 col = Eluna::CHECKVAL<uint32>(E->L, 2);
        CheckFields(E, result);
        E->Push(E->L, RESULT->Fetch()[col].GetBool());
        return 1;
    }
    ...
    int GetUInt8(Eluna* E, ElunaQuery* result)
    {
        uint32 col = Eluna::CHECKVAL<uint32>(E->L, 2);
        CheckFields(E, result);
        E->Push(E->L, RESULT->Fetch()[col].GetUInt8());
        return 1;
    }
    ...
    int GetUInt16(Eluna* E, ElunaQuery* result)
    {
        uint32 col = Eluna::CHECKVAL<uint32>(E->L, 2);
        CheckFields(E, result);
        E->Push(E->L, RESULT->Fetch()[col].GetUInt16());
        return 1;
    }
    ...
    int GetUInt32(Eluna* E, ElunaQuery* result)
    {
        uint32 col = Eluna::CHECKVAL<uint32>(E->L, 2);
        CheckFields(E, result);
        E->Push(E->L, RESULT->Fetch()[col].GetUInt32());
        return 1;
    }
    ...
    int GetUInt64(Eluna* E, ElunaQuery* result)
    {
        uint32 col = Eluna::CHECKVAL<uint32>(E->L, 2);
        CheckFields(E, result);
        E->Push(E->L, RESULT->Fetch()[col].GetUInt64());
        return 1;
    }
    ...
    int GetInt8(Eluna* E, ElunaQuery* result)
    {
        uint32 col = Eluna::CHECKVAL<uint32>(E->L, 2);
        CheckFields(E, result);
        E->Push(E->L, RESULT->Fetch()[col].GetInt8());
        return 1;
    }
    ...
    int GetInt16(Eluna* E, ElunaQuery* result)
    {
        uint32 col = Eluna::CHECKVAL<uint32>(E->L, 2);
        CheckFields(E, result);
        E->Push(E->L, RESULT->Fetch()[col].GetInt16());
        return 1;
    }
    ...
    int GetInt32(Eluna* E, ElunaQuery* result)
    {
        uint32 col = Eluna::CHECKVAL<uint32>(E->L, 2);
        CheckFields(E, result);
        E->Push(E->L, RESULT->Fetch()[col].GetInt32());
        return 1;
    }
    ...
    int GetInt64(Eluna* E, ElunaQuery* result)
    {
        uint32 col = Eluna::CHECKVAL<uint32>(E->L, 2);
        CheckFields(E, result);
        E->Push(E->L, RESULT->Fetch()[col].GetInt64());
        return 1;
    }
    ...
    int GetFloat(Eluna* E, ElunaQuery* result)
    {
        uint32 col = Eluna::CHECKVAL<uint32>(E->L, 2);
        CheckFields(E, result);
        E->Push(E->L, RESULT->Fetch()[col].GetFloat());
        return 1;
    }
    ...
    int GetDouble(Eluna* E, ElunaQuery* result)
    {
        uint32 col = Eluna::CHECKVAL<uint32>(E->L, 2);
        CheckFields(E, result);
        E->Push(E->L, RESULT->Fetch()[col].GetDouble());
        return 1;
    }
...
#ifndef TRINITY
        E->Push(E->L, RESULT->Fetch()[col].GetString());
#else
        E->Push(E->L, RESULT->Fetch()[col].GetCString());
#endif
        return 1;
    }
    ...
    int GetRow(Eluna* E, ElunaQuery* result)
    {
        ...
        {
#if defined TRINITY || AZEROTHCORE
            E->Push(E->L, RESULT->GetFieldName(i));
