...
namespace LuaCreature
{
    ...
    */
    ...
    {
        // Getters
        { "GetAITarget", &LuaCreature::GetAITarget, METHOD_REG_ALL },
        { "GetAITargets", &LuaCreature::GetAITargets, METHOD_REG_ALL },
        { "GetAITargetsCount", &LuaCreature::GetAITargetsCount, METHOD_REG_ALL },
        { "GetHomePosition", &LuaCreature::GetHomePosition, METHOD_REG_ALL },
        { "GetCorpseDelay", &LuaCreature::GetCorpseDelay, METHOD_REG_ALL },
        { "GetCreatureSpellCooldownDelay", &LuaCreature::GetCreatureSpellCooldownDelay, METHOD_REG_ALL },
        { "GetScriptId", &LuaCreature::GetScriptId, METHOD_REG_ALL },
        { "GetAIName", &LuaCreature::GetAIName, METHOD_REG_ALL },
        { "GetScriptName", &LuaCreature::GetScriptName, METHOD_REG_ALL },
        { "GetAttackDistance", &LuaCreature::GetAttackDistance, METHOD_REG_ALL },
        { "GetAggroRange", &LuaCreature::GetAggroRange, METHOD_REG_ALL },
        { "GetDefaultMovementType", &LuaCreature::GetDefaultMovementType, METHOD_REG_ALL },
        { "GetRespawnDelay", &LuaCreature::GetRespawnDelay, METHOD_REG_ALL },
        { "GetWanderRadius", &LuaCreature::GetWanderRadius, METHOD_REG_ALL },
        { "GetCurrentWaypointId", &LuaCreature::GetCurrentWaypointId, METHOD_REG_ALL },
        { "GetWaypointPath", &LuaCreature::GetWaypointPath, METHOD_REG_ALL },
        { "GetLootMode", &LuaCreature::GetLootMode, METHOD_REG_ALL },
        { "GetLootRecipient", &LuaCreature::GetLootRecipient, METHOD_REG_ALL },
        { "GetLootRecipientGroup", &LuaCreature::GetLootRecipientGroup, METHOD_REG_ALL },
        { "GetNPCFlags", &LuaCreature::GetNPCFlags, METHOD_REG_ALL },
        { "GetExtraFlags", &LuaCreature::GetExtraFlags, METHOD_REG_ALL },
#ifndef CATA
        { "GetShieldBlockValue", &LuaCreature::GetShieldBlockValue, METHOD_REG_ALL },
#endif
        { "GetDBTableGUIDLow", &LuaCreature::GetDBTableGUIDLow, METHOD_REG_ALL },
        { "GetCreatureFamily", &LuaCreature::GetCreatureFamily, METHOD_REG_ALL },

        // Setters
        { "SetRegeneratingHealth", &LuaCreature::SetRegeneratingHealth, METHOD_REG_ALL },
        { "SetHover", &LuaCreature::SetHover, METHOD_REG_ALL },
        { "SetDisableGravity", &LuaCreature::SetDisableGravity, METHOD_REG_ALL },
        { "SetAggroEnabled", &LuaCreature::SetAggroEnabled, METHOD_REG_ALL },
        { "SetNoCallAssistance", &LuaCreature::SetNoCallAssistance, METHOD_REG_ALL },
        { "SetNoSearchAssistance", &LuaCreature::SetNoSearchAssistance, METHOD_REG_ALL },
        { "SetDefaultMovementType", &LuaCreature::SetDefaultMovementType, METHOD_REG_ALL },
        { "SetRespawnDelay", &LuaCreature::SetRespawnDelay, METHOD_REG_ALL },
        { "SetWanderRadius", &LuaCreature::SetWanderRadius, METHOD_REG_ALL },
        { "SetInCombatWithZone", &LuaCreature::SetInCombatWithZone, METHOD_REG_ALL },
        { "SetDisableReputationGain", &LuaCreature::SetDisableReputationGain, METHOD_REG_ALL },
        { "SetLootMode", &LuaCreature::SetLootMode, METHOD_REG_ALL },
        { "SetNPCFlags", &LuaCreature::SetNPCFlags, METHOD_REG_ALL },
        { "SetReactState", &LuaCreature::SetReactState, METHOD_REG_ALL },
        { "SetDeathState", &LuaCreature::SetDeathState, METHOD_REG_ALL },
        { "SetWalk", &LuaCreature::SetWalk, METHOD_REG_ALL },
        { "SetHomePosition", &LuaCreature::SetHomePosition, METHOD_REG_ALL },
        { "SetEquipmentSlots", &LuaCreature::SetEquipmentSlots, METHOD_REG_ALL },

        // Boolean
        { "IsRegeneratingHealth", &LuaCreature::IsRegeneratingHealth, METHOD_REG_ALL },
        { "IsDungeonBoss", &LuaCreature::IsDungeonBoss, METHOD_REG_ALL },
        { "IsWorldBoss", &LuaCreature::IsWorldBoss, METHOD_REG_ALL },
        { "IsRacialLeader", &LuaCreature::IsRacialLeader, METHOD_REG_ALL },
        { "IsCivilian", &LuaCreature::IsCivilian, METHOD_REG_ALL },
        { "IsTrigger", &LuaCreature::IsTrigger, METHOD_REG_ALL },
        { "IsGuard", &LuaCreature::IsGuard, METHOD_REG_ALL },
        { "IsElite", &LuaCreature::IsElite, METHOD_REG_ALL },
        { "IsInEvadeMode", &LuaCreature::IsInEvadeMode, METHOD_REG_ALL },
        { "HasCategoryCooldown", &LuaCreature::HasCategoryCooldown, METHOD_REG_ALL },
        { "CanWalk", &LuaCreature::CanWalk, METHOD_REG_ALL },
        { "CanSwim", &LuaCreature::CanSwim, METHOD_REG_ALL },
        { "CanAggro", &LuaCreature::CanAggro, METHOD_REG_ALL },
        { "CanStartAttack", &LuaCreature::CanStartAttack, METHOD_REG_ALL },
        { "HasSearchedAssistance", &LuaCreature::HasSearchedAssistance, METHOD_REG_ALL },
        { "IsTappedBy", &LuaCreature::IsTappedBy, METHOD_REG_ALL },
        { "HasLootRecipient", &LuaCreature::HasLootRecipient, METHOD_REG_ALL },
        { "CanAssistTo", &LuaCreature::CanAssistTo, METHOD_REG_ALL },
        { "IsTargetableForAttack", &LuaCreature::IsTargetableForAttack, METHOD_REG_ALL },
        { "CanCompleteQuest", &LuaCreature::CanCompleteQuest, METHOD_REG_ALL },
        { "IsReputationGainDisabled", &LuaCreature::IsReputationGainDisabled, METHOD_REG_ALL },
        { "IsDamageEnoughForLootingAndReward", &LuaCreature::IsDamageEnoughForLootingAndReward, METHOD_REG_ALL },
        { "HasLootMode", &LuaCreature::HasLootMode, METHOD_REG_ALL },
        { "HasSpell", &LuaCreature::HasSpell, METHOD_REG_ALL },
        { "HasQuest", &LuaCreature::HasQuest, METHOD_REG_ALL },
        { "HasSpellCooldown", &LuaCreature::HasSpellCooldown, METHOD_REG_ALL },
        { "CanFly", &LuaCreature::CanFly, METHOD_REG_ALL },

        // Other
        { "FleeToGetAssistance", &LuaCreature::FleeToGetAssistance, METHOD_REG_ALL },
        { "CallForHelp", &LuaCreature::CallForHelp, METHOD_REG_ALL },
        { "CallAssistance", &LuaCreature::CallAssistance, METHOD_REG_ALL },
        { "RemoveCorpse", &LuaCreature::RemoveCorpse, METHOD_REG_ALL },
        { "DespawnOrUnsummon", &LuaCreature::DespawnOrUnsummon, METHOD_REG_ALL },
        { "Respawn", &LuaCreature::Respawn, METHOD_REG_ALL },
        { "AttackStart", &LuaCreature::AttackStart, METHOD_REG_ALL },
        { "AddLootMode", &LuaCreature::AddLootMode, METHOD_REG_ALL },
        { "ResetLootMode", &LuaCreature::ResetLootMode, METHOD_REG_ALL },
        { "RemoveLootMode", &LuaCreature::RemoveLootMode, METHOD_REG_ALL },
        { "SaveToDB", &LuaCreature::SaveToDB, METHOD_REG_ALL },
        { "SelectVictim", &LuaCreature::SelectVictim, METHOD_REG_ALL },
        { "MoveWaypoint", &LuaCreature::MoveWaypoint, METHOD_REG_ALL },
        { "UpdateEntry", &LuaCreature::UpdateEntry, METHOD_REG_ALL },

#ifdef CATA //Not implemented in TCPP
        { "GetShieldBlockValue", nullptr, METHOD_REG_ALL },
#endif
