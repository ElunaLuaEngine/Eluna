...
namespace LuaGlobalFunctions
{
    ...
    */
    ...
    {
        // Hooks
        { "RegisterPacketEvent", &LuaGlobalFunctions::RegisterPacketEvent, METHOD_REG_ALL },
        { "RegisterServerEvent", &LuaGlobalFunctions::RegisterServerEvent, METHOD_REG_ALL },
        { "RegisterPlayerEvent", &LuaGlobalFunctions::RegisterPlayerEvent, METHOD_REG_ALL },
        { "RegisterGuildEvent", &LuaGlobalFunctions::RegisterGuildEvent, METHOD_REG_ALL },
        { "RegisterGroupEvent", &LuaGlobalFunctions::RegisterGroupEvent, METHOD_REG_ALL },
        { "RegisterCreatureEvent", &LuaGlobalFunctions::RegisterCreatureEvent, METHOD_REG_ALL },
        { "RegisterUniqueCreatureEvent", &LuaGlobalFunctions::RegisterUniqueCreatureEvent, METHOD_REG_ALL },
        { "RegisterCreatureGossipEvent", &LuaGlobalFunctions::RegisterCreatureGossipEvent, METHOD_REG_ALL },
        { "RegisterGameObjectEvent", &LuaGlobalFunctions::RegisterGameObjectEvent, METHOD_REG_ALL },
        { "RegisterGameObjectGossipEvent", &LuaGlobalFunctions::RegisterGameObjectGossipEvent, METHOD_REG_ALL },
        { "RegisterItemEvent", &LuaGlobalFunctions::RegisterItemEvent, METHOD_REG_ALL },
        { "RegisterItemGossipEvent", &LuaGlobalFunctions::RegisterItemGossipEvent, METHOD_REG_ALL },
        { "RegisterPlayerGossipEvent", &LuaGlobalFunctions::RegisterPlayerGossipEvent, METHOD_REG_ALL },
        { "RegisterBGEvent", &LuaGlobalFunctions::RegisterBGEvent, METHOD_REG_ALL },
        { "RegisterMapEvent", &LuaGlobalFunctions::RegisterMapEvent, METHOD_REG_ALL },
        { "RegisterInstanceEvent", &LuaGlobalFunctions::RegisterInstanceEvent, METHOD_REG_ALL },

        { "ClearBattleGroundEvents", &LuaGlobalFunctions::ClearBattleGroundEvents, METHOD_REG_ALL },
        { "ClearCreatureEvents", &LuaGlobalFunctions::ClearCreatureEvents, METHOD_REG_ALL },
        { "ClearUniqueCreatureEvents", &LuaGlobalFunctions::ClearUniqueCreatureEvents, METHOD_REG_ALL },
        { "ClearCreatureGossipEvents", &LuaGlobalFunctions::ClearCreatureGossipEvents, METHOD_REG_ALL },
        { "ClearGameObjectEvents", &LuaGlobalFunctions::ClearGameObjectEvents, METHOD_REG_ALL },
        { "ClearGameObjectGossipEvents", &LuaGlobalFunctions::ClearGameObjectGossipEvents, METHOD_REG_ALL },
        { "ClearGroupEvents", &LuaGlobalFunctions::ClearGroupEvents, METHOD_REG_ALL },
        { "ClearGuildEvents", &LuaGlobalFunctions::ClearGuildEvents, METHOD_REG_ALL },
        { "ClearItemEvents", &LuaGlobalFunctions::ClearItemEvents, METHOD_REG_ALL },
        { "ClearItemGossipEvents", &LuaGlobalFunctions::ClearItemGossipEvents, METHOD_REG_ALL },
        { "ClearPacketEvents", &LuaGlobalFunctions::ClearPacketEvents, METHOD_REG_ALL },
        { "ClearPlayerEvents", &LuaGlobalFunctions::ClearPlayerEvents, METHOD_REG_ALL },
        { "ClearPlayerGossipEvents", &LuaGlobalFunctions::ClearPlayerGossipEvents, METHOD_REG_ALL },
        { "ClearServerEvents", &LuaGlobalFunctions::ClearServerEvents, METHOD_REG_ALL },
        { "ClearMapEvents", &LuaGlobalFunctions::ClearMapEvents, METHOD_REG_ALL },
        { "ClearInstanceEvents", &LuaGlobalFunctions::ClearInstanceEvents, METHOD_REG_ALL },

        // Getters
        { "GetLuaEngine", &LuaGlobalFunctions::GetLuaEngine, METHOD_REG_ALL },
        { "GetCoreName", &LuaGlobalFunctions::GetCoreName, METHOD_REG_ALL },
        { "GetRealmID", &LuaGlobalFunctions::GetRealmID, METHOD_REG_ALL },
        { "GetCoreVersion", &LuaGlobalFunctions::GetCoreVersion, METHOD_REG_ALL },
        { "GetCoreExpansion", &LuaGlobalFunctions::GetCoreExpansion, METHOD_REG_ALL },
        { "GetStateMapId", &LuaGlobalFunctions::GetStateMapId, METHOD_REG_ALL },
        { "GetQuest", &LuaGlobalFunctions::GetQuest, METHOD_REG_ALL },
        { "GetPlayerByGUID", &LuaGlobalFunctions::GetPlayerByGUID, METHOD_REG_ALL },
        { "GetPlayerByName", &LuaGlobalFunctions::GetPlayerByName, METHOD_REG_ALL },
        { "GetGameTime", &LuaGlobalFunctions::GetGameTime, METHOD_REG_ALL },
        { "GetPlayersInWorld", &LuaGlobalFunctions::GetPlayersInWorld, METHOD_REG_ALL },
        { "GetGuildByName", &LuaGlobalFunctions::GetGuildByName, METHOD_REG_ALL },
        { "GetGuildByLeaderGUID", &LuaGlobalFunctions::GetGuildByLeaderGUID, METHOD_REG_ALL },
        { "GetPlayerCount", &LuaGlobalFunctions::GetPlayerCount, METHOD_REG_ALL },
        { "GetPlayerGUID", &LuaGlobalFunctions::GetPlayerGUID, METHOD_REG_ALL },
        { "GetItemGUID", &LuaGlobalFunctions::GetItemGUID, METHOD_REG_ALL },
        { "GetObjectGUID", &LuaGlobalFunctions::GetObjectGUID, METHOD_REG_ALL },
        { "GetUnitGUID", &LuaGlobalFunctions::GetUnitGUID, METHOD_REG_ALL },
        { "GetGUIDLow", &LuaGlobalFunctions::GetGUIDLow, METHOD_REG_ALL },
        { "GetGUIDType", &LuaGlobalFunctions::GetGUIDType, METHOD_REG_ALL },
        { "GetGUIDEntry", &LuaGlobalFunctions::GetGUIDEntry, METHOD_REG_ALL },
        { "GetAreaName", &LuaGlobalFunctions::GetAreaName, METHOD_REG_ALL },
        { "bit_not", &LuaGlobalFunctions::bit_not, METHOD_REG_ALL },
        { "bit_xor", &LuaGlobalFunctions::bit_xor, METHOD_REG_ALL },
        { "bit_rshift", &LuaGlobalFunctions::bit_rshift, METHOD_REG_ALL },
        { "bit_lshift", &LuaGlobalFunctions::bit_lshift, METHOD_REG_ALL },
        { "bit_or", &LuaGlobalFunctions::bit_or, METHOD_REG_ALL },
        { "bit_and", &LuaGlobalFunctions::bit_and, METHOD_REG_ALL },
        { "GetItemLink", &LuaGlobalFunctions::GetItemLink, METHOD_REG_ALL },
        { "GetMapById", &LuaGlobalFunctions::GetMapById, METHOD_REG_ALL },
        { "GetCurrTime", &LuaGlobalFunctions::GetCurrTime, METHOD_REG_ALL },
        { "GetTimeDiff", &LuaGlobalFunctions::GetTimeDiff, METHOD_REG_ALL },
        { "PrintInfo", &LuaGlobalFunctions::PrintInfo, METHOD_REG_ALL },
        { "PrintError", &LuaGlobalFunctions::PrintError, METHOD_REG_ALL },
        { "PrintDebug", &LuaGlobalFunctions::PrintDebug, METHOD_REG_ALL },
        { "GetActiveGameEvents", &LuaGlobalFunctions::GetActiveGameEvents, METHOD_REG_ALL },

        // Boolean
        { "IsInventoryPos", &LuaGlobalFunctions::IsInventoryPos, METHOD_REG_ALL },
        { "IsEquipmentPos", &LuaGlobalFunctions::IsEquipmentPos, METHOD_REG_ALL },
        { "IsBankPos", &LuaGlobalFunctions::IsBankPos, METHOD_REG_ALL },
        { "IsBagPos", &LuaGlobalFunctions::IsBagPos, METHOD_REG_ALL },
        { "IsGameEventActive", &LuaGlobalFunctions::IsGameEventActive, METHOD_REG_ALL },

        // Other
        { "ReloadEluna", &LuaGlobalFunctions::ReloadEluna, METHOD_REG_ALL },
        { "RunCommand", &LuaGlobalFunctions::RunCommand, METHOD_REG_ALL },
        { "SendWorldMessage", &LuaGlobalFunctions::SendWorldMessage, METHOD_REG_ALL },
        { "WorldDBQuery", &LuaGlobalFunctions::WorldDBQuery, METHOD_REG_ALL },
        { "WorldDBExecute", &LuaGlobalFunctions::WorldDBExecute, METHOD_REG_ALL },
        { "WorldDBQueryAsync", &LuaGlobalFunctions::WorldDBQueryAsync, METHOD_REG_ALL },
        { "CharDBQuery", &LuaGlobalFunctions::CharDBQuery, METHOD_REG_ALL },
        { "CharDBExecute", &LuaGlobalFunctions::CharDBExecute, METHOD_REG_ALL },
        { "CharDBQueryAsync", &LuaGlobalFunctions::CharDBQueryAsync, METHOD_REG_ALL },
        { "AuthDBQuery", &LuaGlobalFunctions::AuthDBQuery, METHOD_REG_ALL },
        { "AuthDBExecute", &LuaGlobalFunctions::AuthDBExecute, METHOD_REG_ALL },
        { "AuthDBQueryAsync", &LuaGlobalFunctions::AuthDBQueryAsync, METHOD_REG_ALL },
        { "CreateLuaEvent", &LuaGlobalFunctions::CreateLuaEvent, METHOD_REG_ALL },
        { "RemoveEventById", &LuaGlobalFunctions::RemoveEventById, METHOD_REG_ALL },
        { "RemoveEvents", &LuaGlobalFunctions::RemoveEvents, METHOD_REG_ALL },
        { "PerformIngameSpawn", &LuaGlobalFunctions::PerformIngameSpawn, METHOD_REG_ALL },
        { "CreatePacket", &LuaGlobalFunctions::CreatePacket, METHOD_REG_ALL },
        { "AddVendorItem", &LuaGlobalFunctions::AddVendorItem, METHOD_REG_ALL },
        { "VendorRemoveItem", &LuaGlobalFunctions::VendorRemoveItem, METHOD_REG_ALL },
        { "VendorRemoveAllItems", &LuaGlobalFunctions::VendorRemoveAllItems, METHOD_REG_ALL },
        { "Kick", &LuaGlobalFunctions::Kick, METHOD_REG_ALL },
        { "Ban", &LuaGlobalFunctions::Ban, METHOD_REG_ALL },
        { "SaveAllPlayers", &LuaGlobalFunctions::SaveAllPlayers, METHOD_REG_ALL },
        { "SendMail", &LuaGlobalFunctions::SendMail, METHOD_REG_ALL },
        { "AddTaxiPath", &LuaGlobalFunctions::AddTaxiPath, METHOD_REG_ALL },
        { "CreateInt64", &LuaGlobalFunctions::CreateLongLong, METHOD_REG_ALL },
        { "CreateUint64", &LuaGlobalFunctions::CreateULongLong, METHOD_REG_ALL },
        { "StartGameEvent", &LuaGlobalFunctions::StartGameEvent, METHOD_REG_ALL },
        { "StopGameEvent", &LuaGlobalFunctions::StopGameEvent, METHOD_REG_ALL },
