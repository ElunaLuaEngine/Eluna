...
namespace LuaPlayer
{
    ...
    {
        // Getters
        { "GetSelection", &LuaPlayer::GetSelection, METHOD_REG_ALL },
        { "GetGMRank", &LuaPlayer::GetGMRank, METHOD_REG_ALL },
        { "GetGuildId", &LuaPlayer::GetGuildId, METHOD_REG_ALL },
        { "GetCoinage", &LuaPlayer::GetCoinage, METHOD_REG_ALL },
        { "GetTeam", &LuaPlayer::GetTeam, METHOD_REG_ALL },
        { "GetItemCount", &LuaPlayer::GetItemCount, METHOD_REG_ALL },
        { "GetGroup", &LuaPlayer::GetGroup, METHOD_REG_ALL },
        { "GetGuild", &LuaPlayer::GetGuild, METHOD_REG_ALL },
        { "GetAccountId", &LuaPlayer::GetAccountId, METHOD_REG_ALL },
        { "GetAccountName", &LuaPlayer::GetAccountName, METHOD_REG_ALL },
#ifndef CATA
        { "GetArenaPoints", &LuaPlayer::GetArenaPoints, METHOD_REG_ALL },
        { "GetHonorPoints", &LuaPlayer::GetHonorPoints, METHOD_REG_ALL },
#endif
        { "GetLifetimeKills", &LuaPlayer::GetLifetimeKills, METHOD_REG_ALL },
        { "GetPlayerIP", &LuaPlayer::GetPlayerIP, METHOD_REG_ALL },
        { "GetLevelPlayedTime", &LuaPlayer::GetLevelPlayedTime, METHOD_REG_ALL },
        { "GetTotalPlayedTime", &LuaPlayer::GetTotalPlayedTime, METHOD_REG_ALL },
        { "GetItemByPos", &LuaPlayer::GetItemByPos, METHOD_REG_ALL },
        { "GetItemByEntry", &LuaPlayer::GetItemByEntry, METHOD_REG_ALL },
        { "GetItemByGUID", &LuaPlayer::GetItemByGUID, METHOD_REG_ALL },
        { "GetMailItem", &LuaPlayer::GetMailItem, METHOD_REG_ALL },
        { "GetReputation", &LuaPlayer::GetReputation, METHOD_REG_ALL },
        { "GetEquippedItemBySlot", &LuaPlayer::GetEquippedItemBySlot, METHOD_REG_ALL },
        { "GetQuestLevel", &LuaPlayer::GetQuestLevel, METHOD_REG_ALL },
        { "GetChatTag", &LuaPlayer::GetChatTag, METHOD_REG_ALL },
        { "GetRestBonus", &LuaPlayer::GetRestBonus, METHOD_REG_ALL },
#ifndef CATA
        { "GetPhaseMaskForSpawn", &LuaPlayer::GetPhaseMaskForSpawn, METHOD_REG_ALL },
#endif
        { "GetReqKillOrCastCurrentCount", &LuaPlayer::GetReqKillOrCastCurrentCount, METHOD_REG_ALL },
        { "GetQuestStatus", &LuaPlayer::GetQuestStatus, METHOD_REG_ALL },
        { "GetInGameTime", &LuaPlayer::GetInGameTime, METHOD_REG_ALL },
        { "GetComboPoints", &LuaPlayer::GetComboPoints, METHOD_REG_ALL },
        { "GetComboTarget", &LuaPlayer::GetComboTarget, METHOD_REG_ALL },
        { "GetGuildName", &LuaPlayer::GetGuildName, METHOD_REG_ALL },
        { "GetFreeTalentPoints", &LuaPlayer::GetFreeTalentPoints, METHOD_REG_ALL },
        { "GetActiveSpec", &LuaPlayer::GetActiveSpec, METHOD_REG_ALL },
        { "GetSpecsCount", &LuaPlayer::GetSpecsCount, METHOD_REG_ALL },
        { "GetSpellCooldownDelay", &LuaPlayer::GetSpellCooldownDelay, METHOD_REG_ALL },
        { "GetGuildRank", &LuaPlayer::GetGuildRank, METHOD_REG_ALL },
        { "GetDifficulty", &LuaPlayer::GetDifficulty, METHOD_REG_ALL },
        { "GetHealthBonusFromStamina", &LuaPlayer::GetHealthBonusFromStamina, METHOD_REG_ALL },
        { "GetManaBonusFromIntellect", &LuaPlayer::GetManaBonusFromIntellect, METHOD_REG_ALL },
        { "GetMaxSkillValue", &LuaPlayer::GetMaxSkillValue, METHOD_REG_ALL },
        { "GetPureMaxSkillValue", &LuaPlayer::GetPureMaxSkillValue, METHOD_REG_ALL },
        { "GetSkillValue", &LuaPlayer::GetSkillValue, METHOD_REG_ALL },
        { "GetBaseSkillValue", &LuaPlayer::GetBaseSkillValue, METHOD_REG_ALL },
        { "GetPureSkillValue", &LuaPlayer::GetPureSkillValue, METHOD_REG_ALL },
        { "GetSkillPermBonusValue", &LuaPlayer::GetSkillPermBonusValue, METHOD_REG_ALL },
        { "GetSkillTempBonusValue", &LuaPlayer::GetSkillTempBonusValue, METHOD_REG_ALL },
        { "GetReputationRank", &LuaPlayer::GetReputationRank, METHOD_REG_ALL },
        { "GetDrunkValue", &LuaPlayer::GetDrunkValue, METHOD_REG_ALL },
        { "GetBattlegroundId", &LuaPlayer::GetBattlegroundId, METHOD_REG_ALL },
        { "GetBattlegroundTypeId", &LuaPlayer::GetBattlegroundTypeId, METHOD_REG_ALL },
        { "GetXPRestBonus", &LuaPlayer::GetXPRestBonus, METHOD_REG_ALL },
        { "GetGroupInvite", &LuaPlayer::GetGroupInvite, METHOD_REG_ALL },
        { "GetSubGroup", &LuaPlayer::GetSubGroup, METHOD_REG_ALL },
        { "GetNextRandomRaidMember", &LuaPlayer::GetNextRandomRaidMember, METHOD_REG_ALL },
        { "GetOriginalGroup", &LuaPlayer::GetOriginalGroup, METHOD_REG_ALL },
        { "GetOriginalSubGroup", &LuaPlayer::GetOriginalSubGroup, METHOD_REG_ALL },
        { "GetChampioningFaction", &LuaPlayer::GetChampioningFaction, METHOD_REG_ALL },
        { "GetLatency", &LuaPlayer::GetLatency, METHOD_REG_ALL },
        { "GetRecruiterId", &LuaPlayer::GetRecruiterId, METHOD_REG_ALL },
        { "GetDbLocaleIndex", &LuaPlayer::GetDbLocaleIndex, METHOD_REG_ALL },
        { "GetDbcLocale", &LuaPlayer::GetDbcLocale, METHOD_REG_ALL },
        { "GetCorpse", &LuaPlayer::GetCorpse, METHOD_REG_ALL },
        { "GetGossipTextId", &LuaPlayer::GetGossipTextId, METHOD_REG_ALL },
        { "GetQuestRewardStatus", &LuaPlayer::GetQuestRewardStatus, METHOD_REG_ALL },
#ifndef CATA
        { "GetShieldBlockValue", &LuaPlayer::GetShieldBlockValue, METHOD_REG_ALL },
        { "GetMailCount", &LuaPlayer::GetMailCount, METHOD_REG_ALL },
        { "GetXP", &LuaPlayer::GetXP, METHOD_REG_ALL },
        { "GetXPForNextLevel", &LuaPlayer::GetXPForNextLevel, METHOD_REG_ALL },
#endif

        // Setters
#ifndef CATA
        { "AdvanceSkillsToMax", &LuaPlayer::AdvanceSkillsToMax, METHOD_REG_ALL },
#endif
        { "AdvanceSkill", &LuaPlayer::AdvanceSkill, METHOD_REG_ALL },
        { "AdvanceAllSkills", &LuaPlayer::AdvanceAllSkills, METHOD_REG_ALL },
        { "AddLifetimeKills", &LuaPlayer::AddLifetimeKills, METHOD_REG_ALL },
        { "SetCoinage", &LuaPlayer::SetCoinage, METHOD_REG_ALL },
        { "SetKnownTitle", &LuaPlayer::SetKnownTitle, METHOD_REG_ALL },
        { "UnsetKnownTitle", &LuaPlayer::UnsetKnownTitle, METHOD_REG_ALL },
        { "SetBindPoint", &LuaPlayer::SetBindPoint, METHOD_REG_ALL },
#ifndef CATA
        { "SetArenaPoints", &LuaPlayer::SetArenaPoints, METHOD_REG_ALL },
        { "SetHonorPoints", &LuaPlayer::SetHonorPoints, METHOD_REG_ALL },
#endif
        { "SetLifetimeKills", &LuaPlayer::SetLifetimeKills, METHOD_REG_ALL },
        { "SetGameMaster", &LuaPlayer::SetGameMaster, METHOD_REG_ALL },
        { "SetGMChat", &LuaPlayer::SetGMChat, METHOD_REG_ALL },
        { "SetTaxiCheat", &LuaPlayer::SetTaxiCheat, METHOD_REG_ALL },
        { "SetGMVisible", &LuaPlayer::SetGMVisible, METHOD_REG_ALL },
        { "SetPvPDeath", &LuaPlayer::SetPvPDeath, METHOD_REG_ALL },
        { "SetAcceptWhispers", &LuaPlayer::SetAcceptWhispers, METHOD_REG_ALL },
        { "SetRestBonus", &LuaPlayer::SetRestBonus, METHOD_REG_ALL },
        { "SetQuestStatus", &LuaPlayer::SetQuestStatus, METHOD_REG_ALL },
        { "SetReputation", &LuaPlayer::SetReputation, METHOD_REG_ALL },
        { "SetFreeTalentPoints", &LuaPlayer::SetFreeTalentPoints, METHOD_REG_ALL },
        { "SetGuildRank", &LuaPlayer::SetGuildRank, METHOD_REG_ALL },
#ifndef CATA
        { "SetMovement", &LuaPlayer::SetMovement, METHOD_REG_ALL },
#endif
        { "SetSkill", &LuaPlayer::SetSkill, METHOD_REG_ALL },
        { "SetFactionForRace", &LuaPlayer::SetFactionForRace, METHOD_REG_ALL },
        { "SetDrunkValue", &LuaPlayer::SetDrunkValue, METHOD_REG_ALL },
        { "SetAtLoginFlag", &LuaPlayer::SetAtLoginFlag, METHOD_REG_ALL },
        { "SetPlayerLock", &LuaPlayer::SetPlayerLock, METHOD_REG_ALL },
        { "SetGender", &LuaPlayer::SetGender, METHOD_REG_ALL },
        { "SetSheath", &LuaPlayer::SetSheath, METHOD_REG_ALL },
        { "SetFFA", &LuaPlayer::SetFFA, METHOD_REG_ALL },

        // Boolean
        { "IsInGroup", &LuaPlayer::IsInGroup, METHOD_REG_ALL },
        { "IsInGuild", &LuaPlayer::IsInGuild, METHOD_REG_ALL },
        { "IsGM", &LuaPlayer::IsGM, METHOD_REG_ALL },
        { "IsImmuneToDamage", &LuaPlayer::IsImmuneToDamage, METHOD_REG_ALL },
        { "IsAlliance", &LuaPlayer::IsAlliance, METHOD_REG_ALL },
        { "IsHorde", &LuaPlayer::IsHorde, METHOD_REG_ALL },
        { "HasTitle", &LuaPlayer::HasTitle, METHOD_REG_ALL },
        { "HasItem", &LuaPlayer::HasItem, METHOD_REG_ALL },
        { "Teleport", &LuaPlayer::Teleport, METHOD_REG_ALL },
        { "AddItem", &LuaPlayer::AddItem, METHOD_REG_ALL },
        { "IsInArenaTeam", &LuaPlayer::IsInArenaTeam, METHOD_REG_ALL },
        { "CanCompleteQuest", &LuaPlayer::CanCompleteQuest, METHOD_REG_ALL },
        { "CanEquipItem", &LuaPlayer::CanEquipItem, METHOD_REG_ALL },
        { "IsFalling", &LuaPlayer::IsFalling, METHOD_REG_ALL },
        { "ToggleAFK", &LuaPlayer::ToggleAFK, METHOD_REG_ALL },
        { "ToggleDND", &LuaPlayer::ToggleDND, METHOD_REG_ALL },
        { "IsAFK", &LuaPlayer::IsAFK, METHOD_REG_ALL },
        { "IsDND", &LuaPlayer::IsDND, METHOD_REG_ALL },
        { "IsAcceptingWhispers", &LuaPlayer::IsAcceptingWhispers, METHOD_REG_ALL },
        { "IsGMChat", &LuaPlayer::IsGMChat, METHOD_REG_ALL },
        { "IsTaxiCheater", &LuaPlayer::IsTaxiCheater, METHOD_REG_ALL },
        { "IsGMVisible", &LuaPlayer::IsGMVisible, METHOD_REG_ALL },
        { "HasQuest", &LuaPlayer::HasQuest, METHOD_REG_ALL },
        { "InBattlegroundQueue", &LuaPlayer::InBattlegroundQueue, METHOD_REG_ALL },
        { "IsImmuneToEnvironmentalDamage", &LuaPlayer::IsImmuneToEnvironmentalDamage, METHOD_REG_ALL },
        { "CanSpeak", &LuaPlayer::CanSpeak, METHOD_REG_ALL },
        { "HasAtLoginFlag", &LuaPlayer::HasAtLoginFlag, METHOD_REG_ALL },
        { "InRandomLfgDungeon", &LuaPlayer::InRandomLfgDungeon, METHOD_REG_ALL },
        { "HasPendingBind", &LuaPlayer::HasPendingBind, METHOD_REG_ALL },
        { "HasAchieved", &LuaPlayer::HasAchieved, METHOD_REG_ALL },
        { "SetAchievement", &LuaPlayer::SetAchievement, METHOD_REG_ALL },
        { "CanUninviteFromGroup", &LuaPlayer::CanUninviteFromGroup, METHOD_REG_ALL },
        { "IsRested", &LuaPlayer::IsRested, METHOD_REG_ALL },
        { "IsNeverVisible", &LuaPlayer::IsNeverVisible, METHOD_REG_ALL },
        { "IsVisibleForPlayer", &LuaPlayer::IsVisibleForPlayer, METHOD_REG_ALL },
        { "IsUsingLfg", &LuaPlayer::IsUsingLfg, METHOD_REG_ALL },
        { "HasQuestForItem", &LuaPlayer::HasQuestForItem, METHOD_REG_ALL },
        { "HasQuestForGO", &LuaPlayer::HasQuestForGO, METHOD_REG_ALL },
        { "CanShareQuest", &LuaPlayer::CanShareQuest, METHOD_REG_ALL },
        { "HasReceivedQuestReward", &LuaPlayer::HasReceivedQuestReward, METHOD_REG_ALL },
        { "HasTalent", &LuaPlayer::HasTalent, METHOD_REG_ALL },
        { "IsInSameGroupWith", &LuaPlayer::IsInSameGroupWith, METHOD_REG_ALL },
        { "IsInSameRaidWith", &LuaPlayer::IsInSameRaidWith, METHOD_REG_ALL },
        { "IsGroupVisibleFor", &LuaPlayer::IsGroupVisibleFor, METHOD_REG_ALL },
        { "HasSkill", &LuaPlayer::HasSkill, METHOD_REG_ALL },
        { "IsHonorOrXPTarget", &LuaPlayer::IsHonorOrXPTarget, METHOD_REG_ALL },
        { "CanParry", &LuaPlayer::CanParry, METHOD_REG_ALL },
        { "CanBlock", &LuaPlayer::CanBlock, METHOD_REG_ALL },
        { "CanTitanGrip", &LuaPlayer::CanTitanGrip, METHOD_REG_ALL },
        { "InBattleground", &LuaPlayer::InBattleground, METHOD_REG_ALL },
        { "InArena", &LuaPlayer::InArena, METHOD_REG_ALL },
        { "IsOutdoorPvPActive", &LuaPlayer::IsOutdoorPvPActive, METHOD_REG_ALL },
        { "IsARecruiter", &LuaPlayer::IsARecruiter, METHOD_REG_ALL },
        { "CanUseItem", &LuaPlayer::CanUseItem, METHOD_REG_ALL },
        { "HasSpell", &LuaPlayer::HasSpell, METHOD_REG_ALL },
        { "HasSpellCooldown", &LuaPlayer::HasSpellCooldown, METHOD_REG_ALL },
        { "IsInWater", &LuaPlayer::IsInWater, METHOD_REG_ALL },
        { "CanFly", &LuaPlayer::CanFly, METHOD_REG_ALL },
        { "IsMoving", &LuaPlayer::IsMoving, METHOD_REG_ALL },
        { "IsFlying", &LuaPlayer::IsFlying, METHOD_REG_ALL },
#ifndef CATA
        { "CanCompleteRepeatableQuest", &LuaPlayer::CanCompleteRepeatableQuest, METHOD_REG_ALL },
        { "CanRewardQuest", &LuaPlayer::CanRewardQuest, METHOD_REG_ALL },
#endif

        // Gossip
        { "GossipMenuAddItem", &LuaPlayer::GossipMenuAddItem, METHOD_REG_ALL },
        { "GossipSendMenu", &LuaPlayer::GossipSendMenu, METHOD_REG_ALL },
        { "GossipComplete", &LuaPlayer::GossipComplete, METHOD_REG_ALL },
        { "GossipClearMenu", &LuaPlayer::GossipClearMenu, METHOD_REG_ALL },

        // Other
        { "SendBroadcastMessage", &LuaPlayer::SendBroadcastMessage, METHOD_REG_ALL },
        { "SendAreaTriggerMessage", &LuaPlayer::SendAreaTriggerMessage, METHOD_REG_ALL },
        { "SendNotification", &LuaPlayer::SendNotification, METHOD_REG_ALL },
        { "SendPacket", &LuaPlayer::SendPacket, METHOD_REG_ALL },
        { "SendAddonMessage", &LuaPlayer::SendAddonMessage, METHOD_REG_ALL },
        { "ModifyMoney", &LuaPlayer::ModifyMoney, METHOD_REG_ALL },
        { "LearnSpell", &LuaPlayer::LearnSpell, METHOD_REG_ALL },
        { "LearnTalent", &LuaPlayer::LearnTalent, METHOD_REG_ALL },
        { "RemoveArenaSpellCooldowns", &LuaPlayer::RemoveArenaSpellCooldowns, METHOD_REG_ALL },
        { "RemoveItem", &LuaPlayer::RemoveItem, METHOD_REG_ALL },
        { "RemoveLifetimeKills", &LuaPlayer::RemoveLifetimeKills, METHOD_REG_ALL },
        { "ResurrectPlayer", &LuaPlayer::ResurrectPlayer, METHOD_REG_ALL },
        { "EquipItem", &LuaPlayer::EquipItem, METHOD_REG_ALL },
        { "ResetSpellCooldown", &LuaPlayer::ResetSpellCooldown, METHOD_REG_ALL },
        { "ResetTypeCooldowns", &LuaPlayer::ResetTypeCooldowns, METHOD_REG_ALL },
        { "ResetAllCooldowns", &LuaPlayer::ResetAllCooldowns, METHOD_REG_ALL },
        { "GiveXP", &LuaPlayer::GiveXP, METHOD_REG_ALL },
        { "RemovePet", &LuaPlayer::RemovePet, METHOD_REG_ALL },
        { "SummonPet", &LuaPlayer::SummonPet, METHOD_REG_ALL },
        { "Say", &LuaPlayer::Say, METHOD_REG_ALL },
        { "Yell", &LuaPlayer::Yell, METHOD_REG_ALL },
        { "TextEmote", &LuaPlayer::TextEmote, METHOD_REG_ALL },
        { "Whisper", &LuaPlayer::Whisper, METHOD_REG_ALL },
        { "CompleteQuest", &LuaPlayer::CompleteQuest, METHOD_REG_ALL },
        { "IncompleteQuest", &LuaPlayer::IncompleteQuest, METHOD_REG_ALL },
        { "FailQuest", &LuaPlayer::FailQuest, METHOD_REG_ALL },
        { "AddQuest", &LuaPlayer::AddQuest, METHOD_REG_ALL },
        { "RemoveQuest", &LuaPlayer::RemoveQuest, METHOD_REG_ALL },
        { "RemoveActiveQuest", &LuaPlayer::RemoveActiveQuest, METHOD_REG_ALL },
        { "RemoveRewardedQuest", &LuaPlayer::RemoveRewardedQuest, METHOD_REG_ALL },
        { "AreaExploredOrEventHappens", &LuaPlayer::AreaExploredOrEventHappens, METHOD_REG_ALL },
        { "GroupEventHappens", &LuaPlayer::GroupEventHappens, METHOD_REG_ALL },
        { "KilledMonsterCredit", &LuaPlayer::KilledMonsterCredit, METHOD_REG_ALL },
        { "KilledPlayerCredit", &LuaPlayer::KilledPlayerCredit, METHOD_REG_ALL },
        { "KillGOCredit", &LuaPlayer::KillGOCredit, METHOD_REG_ALL },
        { "TalkedToCreature", &LuaPlayer::TalkedToCreature, METHOD_REG_ALL },
        { "ResetPetTalents", &LuaPlayer::ResetPetTalents, METHOD_REG_ALL },
        { "AddComboPoints", &LuaPlayer::AddComboPoints, METHOD_REG_ALL },
        { "ClearComboPoints", &LuaPlayer::ClearComboPoints, METHOD_REG_ALL },
        { "RemoveSpell", &LuaPlayer::RemoveSpell, METHOD_REG_ALL },
        { "ResetTalents", &LuaPlayer::ResetTalents, METHOD_REG_ALL },
        { "ResetTalentsCost", &LuaPlayer::ResetTalentsCost, METHOD_REG_ALL },
        { "AddTalent", &LuaPlayer::AddTalent, METHOD_REG_ALL },
        { "RemoveFromGroup", &LuaPlayer::RemoveFromGroup, METHOD_REG_ALL },
        { "KillPlayer", &LuaPlayer::KillPlayer, METHOD_REG_ALL },
        { "DurabilityLossAll", &LuaPlayer::DurabilityLossAll, METHOD_REG_ALL },
        { "DurabilityLoss", &LuaPlayer::DurabilityLoss, METHOD_REG_ALL },
        { "DurabilityPointsLoss", &LuaPlayer::DurabilityPointsLoss, METHOD_REG_ALL },
        { "DurabilityPointsLossAll", &LuaPlayer::DurabilityPointsLossAll, METHOD_REG_ALL },
        { "DurabilityPointLossForEquipSlot", &LuaPlayer::DurabilityPointLossForEquipSlot, METHOD_REG_ALL },
        { "DurabilityRepairAll", &LuaPlayer::DurabilityRepairAll, METHOD_REG_ALL },
        { "DurabilityRepair", &LuaPlayer::DurabilityRepair, METHOD_REG_ALL },
#ifndef CATA
        { "ModifyHonorPoints", &LuaPlayer::ModifyHonorPoints, METHOD_REG_ALL },
        { "ModifyArenaPoints", &LuaPlayer::ModifyArenaPoints, METHOD_REG_ALL },
#endif
        { "LeaveBattleground", &LuaPlayer::LeaveBattleground, METHOD_REG_ALL },
        { "BindToInstance", &LuaPlayer::BindToInstance, METHOD_REG_ALL },
        { "UnbindInstance", &LuaPlayer::UnbindInstance, METHOD_REG_ALL },
        { "UnbindAllInstances", &LuaPlayer::UnbindAllInstances, METHOD_REG_ALL },
        { "RemoveFromBattlegroundRaid", &LuaPlayer::RemoveFromBattlegroundRaid, METHOD_REG_ALL },
        { "ResetAchievements", &LuaPlayer::ResetAchievements, METHOD_REG_ALL },
        { "KickPlayer", &LuaPlayer::KickPlayer, METHOD_REG_ALL },
        { "LogoutPlayer", &LuaPlayer::LogoutPlayer, METHOD_REG_ALL },
        { "SendTrainerList", &LuaPlayer::SendTrainerList, METHOD_REG_ALL },
        { "SendListInventory", &LuaPlayer::SendListInventory, METHOD_REG_ALL },
        { "SendShowBank", &LuaPlayer::SendShowBank, METHOD_REG_ALL },
        { "SendTabardVendorActivate", &LuaPlayer::SendTabardVendorActivate, METHOD_REG_ALL },
        { "SendSpiritResurrect", &LuaPlayer::SendSpiritResurrect, METHOD_REG_ALL },
        { "SendTaxiMenu", &LuaPlayer::SendTaxiMenu, METHOD_REG_ALL },
        { "SendUpdateWorldState", &LuaPlayer::SendUpdateWorldState, METHOD_REG_ALL },
        { "RewardQuest", &LuaPlayer::RewardQuest, METHOD_REG_ALL },
        { "SendAuctionMenu", &LuaPlayer::SendAuctionMenu, METHOD_REG_ALL },
        { "SendShowMailBox", &LuaPlayer::SendShowMailBox, METHOD_REG_ALL },
        { "StartTaxi", &LuaPlayer::StartTaxi, METHOD_REG_ALL },
        { "GossipSendPOI", &LuaPlayer::GossipSendPOI, METHOD_REG_ALL },
        { "GossipAddQuests", &LuaPlayer::GossipAddQuests, METHOD_REG_ALL },
        { "SendQuestTemplate", &LuaPlayer::SendQuestTemplate, METHOD_REG_ALL },
        { "SpawnBones", &LuaPlayer::SpawnBones, METHOD_REG_ALL },
        { "RemovedInsignia", &LuaPlayer::RemovedInsignia, METHOD_REG_ALL },
        { "SendGuildInvite", &LuaPlayer::SendGuildInvite, METHOD_REG_ALL },
        { "Mute", &LuaPlayer::Mute, METHOD_REG_ALL },
        { "SummonPlayer", &LuaPlayer::SummonPlayer, METHOD_REG_ALL },
        { "SaveToDB", &LuaPlayer::SaveToDB, METHOD_REG_ALL },
        { "GroupInvite", &LuaPlayer::GroupInvite, METHOD_REG_ALL },
        { "GroupCreate", &LuaPlayer::GroupCreate, METHOD_REG_ALL },
        { "SendCinematicStart", &LuaPlayer::SendCinematicStart, METHOD_REG_ALL },
        { "SendMovieStart", &LuaPlayer::SendMovieStart, METHOD_REG_ALL },
