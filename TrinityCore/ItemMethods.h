...
namespace LuaItem
{
    ...
    {
        // Getters
        { "GetOwnerGUID", &LuaItem::GetOwnerGUID, METHOD_REG_ALL },
        { "GetOwner", &LuaItem::GetOwner, METHOD_REG_ALL },
        { "GetCount", &LuaItem::GetCount, METHOD_REG_ALL },
        { "GetMaxStackCount", &LuaItem::GetMaxStackCount, METHOD_REG_ALL },
        { "GetSlot", &LuaItem::GetSlot, METHOD_REG_ALL },
        { "GetBagSlot", &LuaItem::GetBagSlot, METHOD_REG_ALL },
        { "GetEnchantmentId", &LuaItem::GetEnchantmentId, METHOD_REG_ALL },
        { "GetSpellId", &LuaItem::GetSpellId, METHOD_REG_ALL },
        { "GetSpellTrigger", &LuaItem::GetSpellTrigger, METHOD_REG_ALL },
        { "GetItemLink", &LuaItem::GetItemLink, METHOD_REG_ALL },
        { "GetClass", &LuaItem::GetClass, METHOD_REG_ALL },
        { "GetSubClass", &LuaItem::GetSubClass, METHOD_REG_ALL },
        { "GetName", &LuaItem::GetName, METHOD_REG_ALL },
        { "GetDisplayId", &LuaItem::GetDisplayId, METHOD_REG_ALL },
        { "GetQuality", &LuaItem::GetQuality, METHOD_REG_ALL },
        { "GetBuyCount", &LuaItem::GetBuyCount, METHOD_REG_ALL },
        { "GetBuyPrice", &LuaItem::GetBuyPrice, METHOD_REG_ALL },
        { "GetSellPrice", &LuaItem::GetSellPrice, METHOD_REG_ALL },
        { "GetInventoryType", &LuaItem::GetInventoryType, METHOD_REG_ALL },
        { "GetAllowableClass", &LuaItem::GetAllowableClass, METHOD_REG_ALL },
        { "GetAllowableRace", &LuaItem::GetAllowableRace, METHOD_REG_ALL },
        { "GetItemLevel", &LuaItem::GetItemLevel, METHOD_REG_ALL },
        { "GetRequiredLevel", &LuaItem::GetRequiredLevel, METHOD_REG_ALL },
#ifndef CATA
        { "GetStatsCount", &LuaItem::GetStatsCount, METHOD_REG_ALL },
#endif
        { "GetRandomProperty", &LuaItem::GetRandomProperty, METHOD_REG_ALL },
        { "GetRandomSuffix", &LuaItem::GetRandomSuffix, METHOD_REG_ALL },
        { "GetItemSet", &LuaItem::GetItemSet, METHOD_REG_ALL },
        { "GetBagSize", &LuaItem::GetBagSize, METHOD_REG_ALL },

        // Setters
        { "SetOwner", &LuaItem::SetOwner, METHOD_REG_ALL },
        { "SetBinding", &LuaItem::SetBinding, METHOD_REG_ALL },
        { "SetCount", &LuaItem::SetCount, METHOD_REG_ALL },

        // Boolean
        { "IsSoulBound", &LuaItem::IsSoulBound, METHOD_REG_ALL },
        { "IsBoundAccountWide", &LuaItem::IsBoundAccountWide, METHOD_REG_ALL },
        { "IsBoundByEnchant", &LuaItem::IsBoundByEnchant, METHOD_REG_ALL },
        { "IsNotBoundToPlayer", &LuaItem::IsNotBoundToPlayer, METHOD_REG_ALL },
        { "IsLocked", &LuaItem::IsLocked, METHOD_REG_ALL },
        { "IsBag", &LuaItem::IsBag, METHOD_REG_ALL },
        { "IsCurrencyToken", &LuaItem::IsCurrencyToken, METHOD_REG_ALL },
        { "IsNotEmptyBag", &LuaItem::IsNotEmptyBag, METHOD_REG_ALL },
        { "IsBroken", &LuaItem::IsBroken, METHOD_REG_ALL },
        { "CanBeTraded", &LuaItem::CanBeTraded, METHOD_REG_ALL },
        { "IsInTrade", &LuaItem::IsInTrade, METHOD_REG_ALL },
        { "IsInBag", &LuaItem::IsInBag, METHOD_REG_ALL },
        { "IsEquipped", &LuaItem::IsEquipped, METHOD_REG_ALL },
        { "HasQuest", &LuaItem::HasQuest, METHOD_REG_ALL },
        { "IsPotion", &LuaItem::IsPotion, METHOD_REG_ALL },
#ifndef CATA
        { "IsWeaponVellum", &LuaItem::IsWeaponVellum, METHOD_REG_ALL },
        { "IsArmorVellum", &LuaItem::IsArmorVellum, METHOD_REG_ALL },
        { "IsRefundExpired", &LuaItem::IsRefundExpired, METHOD_REG_ALL },
#endif
        { "IsConjuredConsumable", &LuaItem::IsConjuredConsumable, METHOD_REG_ALL },
        { "SetEnchantment", &LuaItem::SetEnchantment, METHOD_REG_ALL },
        { "ClearEnchantment", &LuaItem::ClearEnchantment, METHOD_REG_ALL },

        // Other
        { "SaveToDB", &LuaItem::SaveToDB, METHOD_REG_ALL },
