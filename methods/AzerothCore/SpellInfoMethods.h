...
namespace LuaSpellInfo
{
    ...
    {
        E->Push(spellInfo->GetSpellInfo()->SpellPriority);
        return 1;
    }
     ...
     *
     * @param [Unit] caster : the caster to check from
    ...
    ElunaRegister<ElunaSpellInfo> SpellInfoMethods[] =
    {
        ...
        { "GetAllowedMechanicMask",                     METHOD_REG_NONE },
        ...
        { "GetDiminishingReturnsGroupForSpell",         METHOD_REG_NONE },
        { "GetDiminishingReturnsGroupType",             METHOD_REG_NONE },
        { "GetDiminishingReturnsMaxLevel",              METHOD_REG_NONE },
        { "GetDiminishingReturnsLimitDuration",         METHOD_REG_NONE },
        ...
        { "IsStackableOnOneSlotWithDifferentCasters",   METHOD_REG_NONE },
        ...
        { "HasInitialAggro",                            METHOD_REG_NONE },
        ...
        { "CanSpellProvideImmunityAgainstAura",         METHOD_REG_NONE },
        ...
        { "IsItemFitToSpellRequirements",               METHOD_REG_NONE },
        ...
        { "SpellCancelsAuraEffect",                     METHOD_REG_NONE }, // Doesn't exist
