...
namespace LuaUnit
{
    ...
    */
    ...
    int AddFlatStatModifier(Eluna* E, Unit* unit)
    {
        ...
        unit->HandleStatModifier(UnitMods(UNIT_MOD_STAT_START + statType), (UnitModifierType)(modType == 0 ? 0 : 2), value, apply);
        return 0;
    }
    ...
    int AddPctStatModifier(Eluna* E, Unit* unit)
    {
        ...
        unit->HandleStatModifier(UnitMods(UNIT_MOD_STAT_START + statType), (UnitModifierType)(modType == 0 ? 1 : 3), value, apply);
        return 0;
    }
